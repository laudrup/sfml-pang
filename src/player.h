...
private:
  ...
  const std::array<sf::IntRect, 5> walk_textures_ = { sf::IntRect(10, 2, 32, 32),
                                                      sf::IntRect(44, 2, 32, 32),
                                                      sf::IntRect(78, 2, 32, 32),
                                                      sf::IntRect(112, 2, 32, 32),
                                                      sf::IntRect(146, 2, 32, 32) };
  const std::array<sf::IntRect, 3> shoot_textures_ = { sf::IntRect(10, 112, 32, 32),
                                                       sf::IntRect(44, 112, 32, 32),
                                                       sf::IntRect(10, 112, 32, 32) };
  const std::array<sf::IntRect, 2> death_textures_ = { sf::IntRect(78, 112, 48, 32),
